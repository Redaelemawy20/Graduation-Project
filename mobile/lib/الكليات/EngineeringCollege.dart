...
String EngineeringCollegeName="كلية الهندسة";

List <String>EngineeringCollegeList = [
...
List<dynamic> memberOfEngineering = [
  {
...
String WelcomEngineering ="مرحبا بكم فى كلية الهندسة جامعة المنوفية";